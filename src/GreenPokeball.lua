local color = "green"
local kantoLocations = {{-13.50, 3.39}, {-7.24, 3.12}, {-11.19, 7.02}, {1.54, 4.15}, {1.41, 0.92}, {1.51, -2.23}, {1.51, -2.23}, {1.25, 9.38}, {4.48, 8.95}, {4.99, 3.54}, {8.03, 7.90}, {12.49, 1.41}, {18.34, -0.59}, {13.30, -2.91}}
